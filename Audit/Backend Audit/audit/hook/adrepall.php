...
<div id="content" class="col-lg-10 col-sm-10">
  ...
  <div class="box-inner">
    ...
    <?php if (isset($_GET['addon']) && $_GET['addon'] == "yes"): ?>
      ...
      <div class="box-content row"> <p><a class="btn btn-primary" href="<?php echo $_SERVER['PHP_SELF']; ?>?not=3"><i class="glyphicon glyphicon-cloud-download icon-white"></i> Export Csv</a></p>     
      <?php
