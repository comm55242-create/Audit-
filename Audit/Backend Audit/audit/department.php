             ...
             <form action="department.php?subj=<?php echo $d_id; ?>" method="post">
						<table>
							<tr>
								...
								<td><input type="text" name="dname" maxlength="30" class ="form-control"
								value="<?php echo htmlentities($d_name); ?>"  required/>
                                <input type="hidden" name="id_d" maxlength="30" class ="form-control"
								value="<?php echo $d_id; ?>" />
                                </td>
							</tr>
                            <tr>
								<td><label>Shop Code:</label></td>
								<td><input type="text" name="s_code" maxlength="30" class ="form-control"
							...
							<tr>
								<td><label>Audit:</label></td>
								<td><input type="text" name="s_code" maxlength="10" class="form-control"
        ...
        <div class="box-content">
                    <form action="department.php" method="post">
						<table>
							...
							<tr>
								<td><button name="submit" class="btn btn-primary" value="Create Department">Create Shop</button></td>
							</tr>
						</table>
                        </form>
					</div><?php }?>
