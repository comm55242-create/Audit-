...
$ytu = oci_fetch_array($add);
 ...
 if($ytu['ADMIN'] == '1'){ ?>
    ...
    <li role="presentation"><a href="#messages23" aria-controls="messages" role="tab" data-toggle="tab">All Reports</a></li>
	<li role="presentation"><a href="#messages24" aria-controls="messages" role="tab" data-toggle="tab"><?php echo $rita3;?> Stock Audit Report ERP</a></li>
    <?php }else{?>
                        <?php }?>
  </ul>
    <!-- Tab panes -->
 ...
 ?>
	...
	<?php }}?>
				...
				<?php }else{?>
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages2"><?php $trobil = oci_parse($conn, "SELECT DISTINCT DEPT FROM MASTER_ITEM ORDER BY DEPT DESC"); 
						oci_execute($trobil);
						while($tifa = oci_fetch_array($trobil)){$dept = $tifa['DEPT'];
						
						?>
                        
                                <div class="list-group">
                	<a href="adrep2.php?tanto=<?php echo $dept;?>" class="list-group-item ">
                    	<h4 class="list-group-item-heading"><?php echo $dept;?></h4>
                       <noscript> <p class="list-group-item-heading"> Audit entries have been made</p> </noscript>
                    </a>   
                </div><?php }?>
				
				</div><div role="tabpanel" class="tab-pane" id="messages23"><a href="adrepall.php" title="View All Report For Today="left"." data-toggle="tooltip" class="btn btn-warning">View Reports</a></div>
                        
    <div role="tabpanel" class="tab-pane" id="messages24"><a href="adrepstr.php" title="View All Report For Today="left"." data-toggle="tooltip" class="btn btn-warning">View Reports</a></div>
