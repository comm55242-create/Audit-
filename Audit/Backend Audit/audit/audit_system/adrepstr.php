...
$dron2 = 'C:\report\books'.$cant$dtime.'.csv';
    ...
    <div class="alert alert-success">
							...
							<strong>Export Successfull on!</strong> <a href="<?php echo 'C:\report\books'.$cant$dtime.'.csv';?>" download = "<?php echo 'books'.$gotru;?>"><?php echo 'C:\report\books'.$cant$dtime.'.csv';?></a>
			  </div> 
   <?php fclose($fp);
