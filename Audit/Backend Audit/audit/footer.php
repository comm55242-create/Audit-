              ...
              <li role="presentation" class="dropdown"> 
                ...
                <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
                  ...
                  <li>
					...
					<li>
                    <a href="#dropdown4" role="tab" id="dropdown2-tab" data-toggle="tab" aria-controls="dropdown3">Audit round 2 Report</a>
                  </li>
                  </li>
...
//$oot = $_SESSION['user_id'];
  ...
  <?php } ?></div>
			...
			<div role="tabpanel" class="tab-pane" id="dropdown4"><a href="adrepall.php?addon=audit2" title="View Audit 2 Report" data-toggle="tooltip" class="btn btn-warning">Viw Audit round 2 Report</a></div>
  ...
  <footer class="row">
    ...
    <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Developed by : <a
        href="http://usman.it/free-responsive-admin-template">Zahed</a></p>
  </footer>
<?php } ?>
