...
//  $SHOP_NAME = $_POST['SHOP_NAME'];
 ...
 //if (!$result_set) {
	 ...
	 //$_SESSION['storename'] = $SHOP_NAME;
     // $_SESSION['storecode'] = $SHOP_CODE;

	 
       
      $_SESSION['username'] = $username;
      $_SESSION['staff_id'] = $username;
      $_SESSION['rack_number'] = $racknumber;
...
<div class="row">
  <div class="col-md-12 center login-header">
    <h2>Welcome To MELCOM SHOP AUDIT </h2>
  </div>
  <!--/span-->
</div><!--/row-->
...
<?php } ?>
  ...
  <div class="input-group input-group-lg">
          <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
          <input type="text" name="racknumber" class="form-control" placeholder="racknumber" required="required">
        </div>
