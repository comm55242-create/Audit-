...
<div id="content" class="col-lg-10 col-sm-10">
  ...
  <div class="box-inner">
    ...
    <div class="box-content row"> 
      ...
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="frm1">
        <table>
          <tr>
            <td>Rack Number:</td> <td><input style="min-width: 100px;" type="text" name="rack_number" class="form-control" value="<?php echo $rack_id; ?>" required=""></td>
          </tr>
          <tr>
            <td>Item Bar Code:</td> <td><input style="min-width: 100px;" type="text" class="form-control" name="barcode" <?php echo $hmm; ?>></td>
          </tr>
          <!--<tr>
          ...
          <tr>
            <td>
              <input type="submit" id="box" name="submit"/></td><td><input type="reset" value="Cancle" /></td>
          </tr>
        </table>
      </form>
...
//$txtitcode=$_POST['item_code'];
	 ...
	 var call = confirm('Item Code $tinto has been counted by $e_name2 with latest count of $Qty Items on $Date. Do you want to update this record?');  
	   if(call == false){
          ...
          ?>
          <div>
            <form action="update.php?un=<?php echo $_SESSION['username']; ?>&rn=<?php echo $_SESSION['rack_number'];?>" method="post" >
              <table>
                <tr><input type="hidden" name="s_code" value="<?php echo $_SESSION['storecode'] ?>"><input type="hidden" name="staff_id" value="<?php echo $_SESSION['staff_id'] ?>">
                <td><?php echo $barcode; ?>,<input type="hidden" name="barcode" value="<?php echo $barcode; ?>"></td>
                <td> <?php echo $item_code; ?>,<input type="hidden" name="item_code" value="<?php echo $item_code; ?>"></td>
                <td><?php echo $i_price; ?>,<input type="hidden" name="i_price" value="<?php echo $i_price; ?>"></td>
                ...
                <tr>
                  <td colspan="3">
                    <table>
                      <tr>
                        <td colspan="2"><?php echo $i_des; ?>,</td>
                      </tr>
                      <tr>
                        <td colspan="">QTY: </td><td><input class="checkqty" type="number" width="6" name="quanttity" maxlength="5" required value="" autofocus>||<input class="qtybtn" type="submit" name="save"  value="Save"/></td>
                      </tr>
                    </table>
                  </td>
                </tr>
