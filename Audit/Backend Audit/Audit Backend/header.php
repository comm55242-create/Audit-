...
$ytu = oci_fetch_array($add);
 ...
 if($ytu['ADMIN'] == "1"){ ?><li><a class="ajax-link" href="department.php"><i class="glyphicon glyphicon-cog"></i><span> &nbsp;&nbsp;Shops</span></a>
                        </li>
...
<div class="list-group">
	<a class="ajax-link list-group-item" href="department.php"> Shops</a>
</div>
<div class="list-group">
    <a class="ajax-link list-group-item" href="stockinit.php"> Stock Initialization</a>
</div>
<div class="list-group">
    <a class="ajax-link list-group-item" href="itemmasterreport.php"> Item Master Report</a>
</div>
<div class="list-group">
	<a class="ajax-link list-group-item" href="new_user.php">User Manager</a>
</div>
<div class="list-group">
	<a class="ajax-link list-group-item" href="logout.php">Logout</a>
</div>
</div>
