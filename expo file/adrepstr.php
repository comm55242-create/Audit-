  ...
  <div class="box-inner">
    ...
    <div class="box-content row"> 
      <p>
        ...
        <button id='exportrecountingreport' class="btn btn-primary" style="margin-left:5px;"><i class="glyphicon glyphicon-cloud-download icon-white"></i> Recounting Report</button>
        <button id='exportvariancereport' class="btn btn-primary" style="margin-left:5px;"><i class="glyphicon glyphicon-cloud-download icon-white"></i> Variance Report</button>
...
<script type="text/javascript">
  ...
  $('#exportrecountingreport').click(function(){

    $.ajax({
      url:'postfolder/export.php',
      type:'post',
      data:'recountingreport=ok',
      dataType:'text',
      success: function(donne, status){
        data = donne.trim()
  ...
  $('#exportvariancereport').click(function(){

    $.ajax({
      url:'postfolder/export.php',
      type:'post',
      data:'variancereport=ok',
      dataType:'text',
      success: function(donne, status){
        data = donne.trim()
