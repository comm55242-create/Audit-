...
public class ViewActivity extends AppCompatActivity {
    ...
    class BackgroundWorker_view extends AsyncTask<String, String, String> {
        ...
        public void onPostExecute(String Result) {
            ...
            try {
                List<Input_values_Vview> Result_list = (List) new Gson().fromJson(Result, new TypeToken<List<Input_values_Vview>>() { // from class: com.melcomgroup.zahed.melcomshoprecount.ViewActivity.BackgroundWorker_view.1
                }.getType());
                if (Result_list == null) {
