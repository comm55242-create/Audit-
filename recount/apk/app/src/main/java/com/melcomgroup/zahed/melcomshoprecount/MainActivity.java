...
public class MainActivity extends AppCompatActivity {
    ...
    public void Onsave(View View) {
        ...
        try {
            ...
            backgroundWorker.execute(this.shop_code_d.getText().toString(), this.item_code_d.getText().toString(), this.qty.getText().toString(), this.username, this.ip_d.getText().toString(), this.zone1);
        } catch (Exception e) {
            Toast.makeText(this, "Connection Problem, Please check WiFi connection", 1).show();
        }
    ...
    class BackgroundWorker extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... params) {
            ...
            return network.post("http://172.16.33.9/recount/api/shop_audit.php", query);
        }
        ...
        public void onPostExecute(String Result) {
            ...
            try {
                List<Input_values> Result_list = (List) new Gson().fromJson(Result, new TypeToken<List<Input_values>>() { // from class: com.melcomgroup.zahed.melcomshoprecount.MainActivity.BackgroundWorker.1
                }.getType());
                if (Result_list == null) {
    ...
    class BackgroundWorker_save extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... params) {
            ...
            String query = builder.build().getEncodedQuery();
            return network.post("http://172.16.33.9/recount/api/upload_audit_shop.php", query);
        }
    ...
    class BackgroundWorker_view extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... params) {
            ...
            String query = builder.build().getEncodedQuery();
            return network.post("http://172.16.33.9/recount/api/shop_report.php", query);
        }
        ...
        public void onPostExecute(String Result) {
            ...
            try {
                List<Input_values> Result_list = (List) new Gson().fromJson(Result, new TypeToken<List<Input_values>>() { // from class: com.melcomgroup.zahed.melcomshoprecount.MainActivity.BackgroundWorker_view.1
                }.getType());
                if (Result_list == null) {
                    throw new Exception("Null response list");
                }
