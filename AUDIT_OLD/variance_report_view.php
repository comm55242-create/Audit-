  ...
  <div class="box-inner">
    ...
    <div class="box-content row"> 
      <p>
        ...
        <button id='export_variancereport' class="btn btn-primary" ><i class="glyphicon glyphicon-cloud-download icon-white"></i> Export CSV</button>
...
<script type="text/javascript">
  ...
  $('#export_variancereport').click(function(){
    $.ajax({
      ...
      success: function(donne, status){
        data = donne.trim()
        $('#dfile').attr('href', 'export/'+data).attr('download',data).text(data)
